...
const Footer = () => {
  return (
    <footer
      id="contact"
      className="relative border-t border-zinc-200 bg-white pt-24 pb-12 overflow-hidden"
    >
      ...
      <div className="site-shell relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div className="lg:col-span-1">
            ...
            <p className="mb-8 max-w-xs leading-relaxed text-zinc-600 font-medium">
            ...
            <div className="flex space-x-4">
              {[Instagram, Linkedin, Twitter].map((Icon, idx) => (
                <a
                  key={idx}
                  href="#"
                  className="flex h-12 w-12 items-center justify-center rounded-full border border-zinc-200 bg-white text-zinc-900 transition-all hover:bg-[var(--primary)] hover:border-[var(--primary)] hover:scale-110 shadow-sm"
                >
                  <Icon size={20} />
                </a>
              ))}
          ...
          <div>
            <h4 className="mb-8 text-sm font-display font-black uppercase tracking-[0.2em] text-zinc-900">Our Services</h4>
            <ul className="space-y-4">
              {["Bespoke Booths", "MO.PO Systems", "QuickBuild", "Mall Activations", "Office Interiors"].map((item) => (
                <li key={item}>
                  <Link href="#" className="group flex items-center text-zinc-600 font-bold transition-colors hover:text-[var(--primary)]">
          ...
          <div>
            <h4 className="mb-8 text-sm font-display font-black uppercase tracking-[0.2em] text-zinc-900">Quick Links</h4>
            <ul className="space-y-4">
          ...
          <div>
            <h4 className="mb-8 text-sm font-display font-black uppercase tracking-[0.2em] text-zinc-900">Contact Details</h4>
            <div className="space-y-6">
              <div className="flex items-start space-x-4 group">
                ...
                <span className="leading-relaxed text-zinc-600 font-bold">
              ...
              <div className="flex items-center space-x-4 group">
                ...
                <a href="mailto:sales@expodigitalgroup.com" className="text-zinc-600 font-bold transition-colors hover:text-[var(--primary)]">
              ...
              <div className="flex items-center space-x-4 group">
                ...
                <a href="tel:+9710000000" className="text-zinc-600 font-bold transition-colors hover:text-[var(--primary)]">
                  +971 (0) 4 000 0000
                </a>
              </div>
            </div>
        ...
        <div className="flex flex-col items-center justify-between gap-6 border-t border-zinc-200 pt-12 md:flex-row">
          ...
          <div className="flex space-x-8 text-sm font-bold text-zinc-500 uppercase tracking-widest">
